...
int main(void)
{
	...
	printf("=== Test 6 : Inversion itérative ===\n");
	printf("Original : ");
	print_list(list, print_int);
	printf("\n");
	mirror_it(&list);
	printf("Après mirror_it : ");
	print_list(list, print_int);
	printf("\n\n");

	printf("=== Test 7 : Inversion récursive ===\n");
	mirror_rec(&list);
	printf("Après mirror_rec (retour à l'original) : ");
	print_list(list, print_int);
	printf("\n\n");

	printf("=== Test 8 : Concaténation ===\n");
	...
	printf("=== Test 9 : Suppression de toutes les occurrences ===\n");
	...
	printf("=== Test 10 : Découpage sup et inf ===\n");
	...
	printf("=== Test 11 : Canonicalisation ===\n");
	...
	printf("=== Test 12 : Recherche triée ===\n");
